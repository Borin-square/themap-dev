...
export default function MktgFlywheelSetupPage() {
  ...
  function deleteGoal(goalName: string) {
    ...
    setConfirmDel(null); showToast("Goal eliminato");
  }
  ...
  function deleteSubgoal(goalName: string, subName: string) {
    ...
    setConfirmDel(null); showToast("Subgoal eliminato");
  }
    ...
    <div>
      ...
      <div className="fws-page">
        ...
        <div className="fws-head">
          ...
          {company?.name || params.company} — Marketing Flywheel Setup
        </div>
        ...
        <div className="ee-subnav" style={{ marginBottom: 16 }}>
          ...
          <Link href={`/${slug}/marketing/flywheel/real`} className="ee-tab">Consuntivo</Link>
        </div>
          ...
          return (
            <div key={fn} className="fws-section">
              <div className="fws-sec-head">
                ...
                <button className="fws-sec-add" onClick={() => openGoalForm(fn, null)}>+ Goal</button>
              </div>
    ...
    <div className="fws-goal-inline-form">
      <div className="fws-gif-row">
        ...
        <select className="fws-inline-select" value={gfFunc} onChange={(e) => setGfFunc(e.target.value)}>
          {MFW_FUNCS.map((f) => <option key={f}>{f}</option>)}
        </select>
